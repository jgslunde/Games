...
DEFAULT_TEMPERATURE_DECAY_MOVES = 60  # For "decay" mode
...
DEFAULT_EVAL_TEMPERATURE_THRESHOLD = 20  # For "fixed" mode
DEFAULT_EVAL_TEMPERATURE_DECAY_MOVES = 60  # For "decay" mode
...
# Replay buffer
DEFAULT_REPLAY_BUFFER_SIZE = 40_000_000
...
# Game rules
DEFAULT_KING_CAPTURE_PIECES = 4  # 2, 3, or 4 pieces needed to capture king
...
DEFAULT_EVAL_WIN_RATE = 0.65
DEFAULT_EVAL_FREQUENCY = 4
DEFAULT_EVAL_VS_RANDOM_FREQUENCY = 2  # Evaluate every iteration until 100% win rate achieved
